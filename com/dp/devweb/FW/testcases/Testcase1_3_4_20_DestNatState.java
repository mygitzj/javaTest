...
/**
 * 
* @Title: Testcase1_3_4_20_DestNatState.java 
* @Description: TODO(目的NAT状态功能测试) 
* @author z01674 
* @date 2015年5月23日 下午3:47:57 
* @version V4.4
 */

public class Testcase1_3_4_20_DestNatState extends CommonObjectScript{
	...
	//进入设备2，判断能否ping通设备3，可以ping通
		...
		//修改设备1中的目的NAT状态为禁用，设备2Ping设备3，不能ping通
		...
		public void deleteDestNAT() throws Exception {
			...
			nat.modifyDestNATState(destname, state1);
			...
			//将目的NAT的状态恢复为启用
			nat.modifyDestNATState(destname, state2);
