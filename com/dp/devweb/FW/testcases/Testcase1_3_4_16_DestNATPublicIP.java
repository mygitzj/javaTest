...
/**
 * 
* @Title: Testcase1_3_4_16_DestNATPublicIP.java 
* @Description: TODO(目的NAT公网IP地址功能测试) 
* @author z01674 
* @date 2015年5月22日 上午11:21:44 
* @version V4.4
 */

public class Testcase1_3_4_16_DestNATPublicIP extends CommonObjectScript{
	...
	//进入设备2，判断能否ping通设备3，可以ping通
		...
		//修改设备1中的目的NAT公网IP为1.1.1.4，设备2Ping设备3，不能ping通
		public String keywords2 = "0 packets received, 100% packet loss";
		public String modyPubIp = "2.1.1.4";
		...
		public void deleteDestNAT() throws Exception {
			...
			//修改目的NAT公网IP
			nat.modifyDestNatPubIP(destname, modyPubIp);
			
			//退出设备页面1进入设备页面2ping设备3，不能ping通
			opr.SwitchToDefault();
			logout();
			sleep(1);
			driver1(Config.webUrl2);
			...
			//将公网Ip地址恢复为2.1.1.2，能够ping通对端
			nat.modifyDestNatPubIP(destname, pubIP);
