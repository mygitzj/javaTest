...
/**
 * 
* @Title: Testcase1_3_5_22_OneToOneNetInterface.java 
* @Description: TODO(一对一NAT公网接口测试) 
* @author z01674 
* @date 2015年7月1日 下午2:08:47 
* @version V4.4
 */

public class Testcase1_3_5_22_OneToOneNetInterface extends CommonObjectScript{
	...
	//启动浏览器
		...
		//更改设备1中的一对一NAT中的公网接口为gige0_1，设备2Ping设备3，不能ping通
		...
		public void deleteDestNAT() throws Exception {
	    	...
	    	Info("打开设备1的页面");
	    	driver1(Config.webUrl1); 
	    	To1Nat.modify1To1Nat(nameNat, netInterface, null, null);
