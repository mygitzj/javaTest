...
/**
 * 
* @Title: Testcase1_3_4_15_DestNATinInterf.java 
* @Description: TODO(目的NAT入接口功能测试) 
* @author z01674 
* @date 2015年5月20日 上午9:35:47 
* @version V4.4
 */

public class Testcase1_3_4_15_DestNATinInterf extends CommonObjectScript {
	...
	//更改设备1中的目的NAT入接口gige0_1，设备2Ping设备3，不能ping通
		...
		public void deleteDestNAT() throws Exception {
			...
			//更改目的NAT的入接口
			nat.modifyDestNatInInterf(destname, Interf);
			...
			//将目的NAT的入接口恢复为gige0_0
			nat.modifyDestNatInInterf(destname, name1_0);
