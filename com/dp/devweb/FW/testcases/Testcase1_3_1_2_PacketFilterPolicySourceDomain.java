...
/**
 * 
* @Title: Testcase1_3_1_2PacketFilterPolicySource.java 
* @Description: TODO(包过滤策略源域功能测试) 
* @author z01674 
* @date 2015年4月9日 上午10:54:38 
* @version V4.4
 */

public class Testcase1_3_1_2_PacketFilterPolicySourceDomain extends CommonObjectScript{
...
///////////////////////////////对设备3进行操作//////////////////////////////////////////////////////
	...
	@Test(enabled = true, priority = 5)
	  ...
	  @Test(enabled = true, priority = 8)
    	 ...
    	 //测试用例21步，将包过滤策略pf的源域改为trust	      
        public  String name1 = "pf";
        public  String sZone1 = "Trust";
      ...
      //退出设备1的页面进入设备2的页面
  	  ...
  	  @Test(enabled = true, priority = 12)
    	 ...
    	 //将FW1中的包过滤策略恢复为Untrust
    	  public  String sZone2 = "Untrust";
    	  
    	  @Test(enabled = true, priority = 13)
    	  public void packetpass() throws Exception {	 
          	Info("转到表格界面");
          	opr.SwitchToFrame();
          	pacflt.modifyPacketFilter(name1, sZone2, dZone1, sAddr1, dAddr1, service1, serviceNames1, time1, action1, state1);
