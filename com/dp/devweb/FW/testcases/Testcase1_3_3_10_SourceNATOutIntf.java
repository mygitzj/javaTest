...
/**
 * 
* @Title: Testcase1_3_1_10SourceNATSourceIP.java 
* @Description: TODO(源NAT出接口功能测试) 
* @author z01674 
* @date 2015年5月11日 上午10:04:31 
* @version V4.4
 */

public class Testcase1_3_3_10_SourceNATOutIntf extends CommonObjectScript{
...
//	退出设备2的页面进入设备1
	...
	//更改FW1中的源NAT的出接口为gige0_0
	public String natName = "nat";
	public String outIntf = "gige0_0";
	@Test(enabled = true, priority = 6)
	 public void modifyFW1 () throws Exception {
		 Nat.modifySourceNatOutIntf(natName, outIntf);
	 }
	...
	//设备2ping设备3，不能ping通，诊断结果为100% packet loss
	...
	//将FW1设备中的源NAT策略中的nat的出接口恢复为gige0_1,则可以ping通
	...
	//更改FW1中的源NAT出接口
	public String outIntf1 = "gige0_1";
	@Test(enabled = true, priority = 10)
	 public void modifyFW12 () throws Exception {
		 Nat.modifySourceNatOutIntf(natName, outIntf1);
		 
		 //进入设备2的页面，设备2可以ping通设备3
		 opr.SwitchToDefault();
	     Info("退出设备1的页面");
	     logout();
	     sleep(1);
