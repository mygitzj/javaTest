...
/**
 * 
* @Title: Testcase1_3_1_6_PacketFilterPolicyService.java 
* @Description: TODO(包过滤策略服务功能测试) 
* @author z01674 
* @date 2015年5月26日 下午9:11:16 
* @version V4.4
 */

public class Testcase1_3_1_6_PacketFilterPolicyService extends CommonObjectScript {
...
///////////////////////////////对设备3进行操作//////////////////////////////////////////////////////
	...
	@Test(enabled = true, priority = 5)
  	 ...
  	 //更改设备1的包过滤策略服务改为FTP
        ...
        public  String[] serviceNames1 = {"FTP"};
  	  ...
  	  //将包过滤策略pf中的服务恢复为any
    	  public  String delService = "预定义服务";
    	  public String[] delServiceName = {"FTP"};  	  
    	  @Test(enabled = true, priority = 18)
    	  public void packetpass() throws Exception {	 
          	Info("转到表格界面");
          	opr.SwitchToFrame();
            pacflt.deleteService(pfname, delService, delServiceName);
