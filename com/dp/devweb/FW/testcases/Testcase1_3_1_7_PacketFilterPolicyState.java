...
/**
 * 
* @Title: Testcase1_3_1_7_PacketFilterPolicyState.java 
* @Description: TODO(包过滤策略状态功能测试) 
* @author z01674 
* @date 2015年5月27日 上午9:33:29 
* @version V4.4
 */

public class Testcase1_3_1_7_PacketFilterPolicyState extends CommonObjectScript{
  	  ...
  	  @Test(enabled = true, priority = 12)
    	 ...
    	 //将FW1中的包过滤策略状态为启用
    	  ...
    	  public void packetpass() throws Exception {	 
          	Info("转到表格界面");
          	opr.SwitchToFrame();
          	pacflt.modifyPacketFilter(name1, sZone1, dZone1, sAddr1, dAddr1, service1, serviceNames1, time1, action1, state2);
