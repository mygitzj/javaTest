...
/**
 * 
* @Title: Testcase1_3_1_3_PacketFilterPolicyDerstDomain.java 
* @Description: TODO(包过滤策略目的域功能测试) 
* @author z01674 
* @date 2015年5月26日 下午7:43:24 
* @version V4.4
 */

public class Testcase1_3_1_3_PacketFilterPolicyDerstDomain extends CommonObjectScript{
...
///////////////////////////////对设备3进行操作//////////////////////////////////////////////////////
	...
	@Test(enabled = true, priority = 5)
	  ...
	  @Test(enabled = true, priority = 8)
    	 ...
    	 //测试用例21步，将包过滤策略pf的目的域改为untrust	      
        public  String name1 = "pf";
        public  String sZone1 = null;
        public  String dZone1 = "Untrust";
      ...
      //退出设备1的页面进入设备2的页面
  	  ...
  	  @Test(enabled = true, priority = 12)
    	 ...
    	 //将FW1中的包过滤策略目的域恢复为Trust
    	  public  String dZone2 = "Trust";
    	  
    	  @Test(enabled = true, priority = 13)
    	  public void packetpass() throws Exception {	 
          	Info("转到表格界面");
          	opr.SwitchToFrame();
          	pacflt.modifyPacketFilter(name1, sZone1, dZone2, sAddr1, dAddr1, service1, serviceNames1, time1, action1, state1);
