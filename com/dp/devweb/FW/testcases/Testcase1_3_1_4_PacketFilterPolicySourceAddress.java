...
public class Testcase1_3_1_4_PacketFilterPolicySourceAddress extends CommonObjectScript{
	  ...
	  @Test(enabled = true, priority = 8)
  	  ...
  	  @Test(enabled = true, priority = 12)
    	 ...
    	 //将FW1中的包过滤策略恢复源地址为any
    	  public  String sAddr2 = "any";
    	  
    	  @Test(enabled = true, priority = 13)
    	  public void packetpass() throws Exception {	 
          	Info("转到表格界面");
          	opr.SwitchToFrame();
          	pacflt.modifyPacketFilter(name1, sZone1, dZone1, sAddr2, dAddr1, service1, serviceNames1, time1, action1, state1);
