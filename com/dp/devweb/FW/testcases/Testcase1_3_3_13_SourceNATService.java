...
/**
 * 
* @Title: Testcase1_3_1_13_SourceNATService.java 
* @Description: TODO(源Nat服务功能测试) 
* @author z01674 
* @date 2015年5月12日 下午2:46:31 
* @version V4.4
 */

public class Testcase1_3_3_13_SourceNATService extends CommonObjectScript {
...
//	退出设备2的页面进入设备1
	...
	//更改FW1中的源NAT中的服务为预定义服务中的FTP
	public String ServiceName = "预定义服务对象";
	public String object = "FTP";
	@Test(enabled = true, priority = 6)
	 public void modifyFW1 () throws Exception {
		 Nat.modifySourceNatService(sNAT,ServiceName, object);
	 }
	...
	//将FW1设备中的源NAT策略的服务恢复为any，设备2能ping通设备3
	...
	//更改FW1中的源NAT策略服务改为any,设备2ping设备3不能ping通
	public String serviceName1 = "Any";
	public String object1 = null;
	@Test(enabled = true, priority = 10)
	 public void modifyFW12 () throws Exception {
		 Nat.modifySourceNatService(sNAT,serviceName1, object1);
		 //切换到默认页面
	     opr.SwitchToDefault();
	     Info("退出设备1的页面");
	     logout();
