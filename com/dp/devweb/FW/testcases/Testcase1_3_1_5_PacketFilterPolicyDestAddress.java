...
/**
 * 
* @Title: Testcase1_3_1_5_PacketFilterPolicyDestAddress.java 
* @Description: TODO(包过滤策略目的地址功能测试) 
* @author z01674 
* @date 2015年5月26日 下午8:59:42 
* @version V4.4
 */

public class Testcase1_3_1_5_PacketFilterPolicyDestAddress extends CommonObjectScript {
...
///////////////////////////////对设备3进行操作//////////////////////////////////////////////////////
	...
	@Test(enabled = true, priority = 5)
	  ...
	  @Test(enabled = true, priority = 8)
  	  ...
  	  //将FW1中的包过滤策略恢复源地址为any
          public  String dAddr2 = "any";
    	  
    	  @Test(enabled = true, priority = 13)
    	  public void packetpass() throws Exception {	 
          	Info("转到表格界面");
          	opr.SwitchToFrame();
          	pacflt.modifyPacketFilter(name1, sZone1, dZone1, sAddr1, dAddr2, service1, serviceNames1, time1, action1, state1);
