...
/**
 * 
* @Title: Testcase1_3_4_17_DestNATService.java 
* @Description: TODO(目的NAT服务功能测试) 
* @author z01674 
* @date 2015年5月23日 上午9:31:28 
* @version V4.4
 */

public class Testcase1_3_4_17_DestNATService extends CommonObjectScript {
...
//	public String pfname3 = "pf-3";
	...
	//进入设备2，判断能否ping通设备3，可以ping通
		...
		//修改设备1中的目的NAT策略服务为ftp，设备2Ping设备3，不能ping通
		public String keywords2 = "0 packets received, 100% packet loss";
		public String modifyService = "ftp";
		public String service1 = "All";
		...
		public void deleteDestNAT() throws Exception {
	    	...
	    	Info("打开设备1的页面");
	    	driver1(Config.webUrl1);
			nat.modifyDestNatService(destname, modifyService);
			...
			//将目的NAT策略服务恢复为all，设备2ping设备3可以ping通
			nat.modifyDestNatService(destname, service1);
