...
/**
 * 
* @Title: Testcase1_3_1_9SourceNATUseOutInterfaceAddr.java 
* @Description: TODO(源NAT借用出接口地址功能测试) 
* @author z01674 
* @date 2015年4月29日 上午10:03:57 
* @version V4.4
 */

public class Testcase1_3_3_9_SourceNATUseOutInterfaceAddr extends CommonObjectScript{
...
//	退出设备2的页面进入设备1
	...
	@Test(enabled = true, priority = 6)
	 public void modifyFW1 () throws Exception {
		 Nat.modifySourceNatState(natName, state1);
	 }
	...
	//将FW1设备中的源NAT策略的状态恢复为启用，设备2能ping通设备3
	...
	//更改FW1中的源NAT策略恢复为启用
	public String state2 = "启用";
	@Test(enabled = true, priority = 10)
	 public void modifyFW12 () throws Exception {
		 Nat.modifySourceNatState(natName, state2);
